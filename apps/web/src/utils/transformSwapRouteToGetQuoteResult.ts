...
// import { routeAmountsToString, SwapRoute } from "@novaswap/smart-order-router";
import { Pool } from "@novaswap/v3-sdk";
import { routeAmountsToString } from "providers/utils/route";
...
export function transformSwapRouteToGetQuoteResult(
  ...
  // alert("transformSwapRouteToGetQuoteResult");
  for (const subRoute of route) {
    ...
    console.log("curRoute", curRoute, routeResponse, "routeResponse");
