...
export const V3_CORE_FACTORY_ADDRESSES: AddressMap = {
  ...
  [ChainId.NOVA_SEPOLIA]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.NOVA_SEPOLIA].v3CoreFactoryAddress,
...
export const QUOTER_V2_ADDRESSES: AddressMap = {
  ...
  [ChainId.NOVA_SEPOLIA]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.NOVA_SEPOLIA].quoterAddress,
  // TODO: Gnosis + Moonbeam contracts to be deployed
};
...
export const NEW_QUOTER_V2_ADDRESSES: AddressMap = {
  ...
  [ChainId.NOVA_SEPOLIA]: '0xa73A1d496dd147e68F557Dd73A28Ad6330777350',
};
...
export const UNISWAP_MULTICALL_ADDRESSES: AddressMap = {
  ...
  [ChainId.NOVA_SEPOLIA]:
    CHAIN_TO_ADDRESSES_MAP[ChainId.NOVA_SEPOLIA].multicallAddress,
  // TODO: Gnosis + Moonbeam contracts to be deployed
};
