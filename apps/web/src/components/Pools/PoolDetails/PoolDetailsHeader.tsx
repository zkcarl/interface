import { ChainId, Currency, Percent } from "@novaswap/sdk-core";
...
function DoubleTokenLogo({
  ...
  return (
    <DoubleLogo
      logo1={currencyInfos[0]?.logoUrl as string}
      logo2={currencyInfos[1]?.logoUrl as string}
      size={size}
    />
  );
}
