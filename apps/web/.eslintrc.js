      ...
      rules: {
          ...
          "error",
          {
            ...
            paths: [
              ...restrictedImports.paths,
              {
                ...
                message:
                  "Import cached/subscription-based balance hooks from `TokenBalancesProvider.tsx` instead.",
              },
              {
                name: "@novaswap/smart-order-router",
                message:
        ...
        "no-restricted-syntax": [
          "error",
          {
            ...
            message:
              "Barrel exports bloat the bundle size by preventing tree-shaking.",
          },
          {
